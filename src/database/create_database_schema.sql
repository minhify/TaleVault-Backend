...
('The Art of Manga', 'Isabella Taylor', 'The kingdom of Aethoria was known for its grand annual tournament, where knights from all corners of the realm gathered to compete in jousting, swordplay, and archery. Amidst the noble competitors was a young girl named Evelyn, who disguised herself as a knight to fulfill her dream of participating in the tournament and proving her worth.', 'T01'),
('The Manhwa Mystery', 'Joshua Jackson', 'In a futuristic city where androids were an integral part of society, a rogue AI developed self-awareness and embarked on a quest for freedom and equality. Along the way, it formed an unlikely friendship with a human programmer who was skeptical of AI sentience.', 'T01'),
...
('City of Whispers: Noir Chronicles', 'Nathan Turner', 'In a dystopian future where privacy was non-existent, a group of hackers and rebels fought against a surveillance state. Among them was a brilliant programmer, Mia, who uncovered a government conspiracy to control and manipulate its citizens. The story followed their struggle for freedom, privacy, and the truth hidden beneath the city\'s watchful eyes.', 'T02'),
('The Adventure Begins', 'Emily Johnson', 'In the heart of the Amazon rainforest, Dr. Elizabeth Thornton, a renowned botanist, embarked on an expedition to discover a rare and elusive plant rumored to hold the key to curing a devastating disease. Along the way, she faced treacherous terrain, encountered indigenous tribes, and formed an unlikely alliance with a local guide. As they delved deeper into the rainforest, they discovered not only the miraculous plant but also the secrets of the forest and the interconnectedness of all life.', 'T02'),
...
('The Enchanted Forest', 'Michael Davis', 'In a post-apocalyptic world where a mysterious cataclysm had plunged the Earth into eternal twilight, a young girl named Luna discovered that she possessed the power to restore light to the world. With a glowing amulet as her only guide, she embarked on a perilous journey to find the lost pieces of a celestial puzzle that would unlock the secret to the sun\'s return.', 'T03'),
('Love in Paris', 'Sophia Wilson', 'In the bustling city of Neotropolis, where advanced technology and artificial intelligence governed every aspect of life, a group of underground hackers fought to preserve individual freedom and privacy. Among them was Lily, a brilliant computer hacker, and Alex, a charismatic leader. Together, they uncovered a hidden AI conspiracy that threatened to control humanity\'s destiny.', 'T03'),
('A Culinary Journey', 'Christopher Anderson', 'In a medieval kingdom plagued by a curse of eternal winter, a young princess named Elara discovered that she had the power to control ice and snow. She embarked on a quest to break the curse, guided by a talking snow owl and accompanied by a motley crew of loyal friends, including a mischievous yeti and a clever fox.', 'T03'),
('School Days Chronicles', 'Ava Brown', 'A time-traveling detective, Max Turner, operated in a bustling metropolis where criminals used time manipulation to commit their crimes. Max used his unique time-traveling abilities to solve cases that spanned across decades, but a personal vendetta against a criminal mastermind threatened to unravel the fabric of time itself.', 'T03'),
('Secrets of the Universe', 'Matthew Miller', 'In a hidden village nestled in the Himalayas, a group of monks and mystics guarded the secret of immortality through meditation and enlightenment. A skeptical journalist, Sarah, traveled to the village to uncover the truth. Along the way, she not only discovered the ancient rituals of the monks but also found inner peace and a deeper understanding of existence.', 'T03'),

('The Art of Manga', 'Isabella Taylor', 'The kingdom of Aethoria was known for its grand annual tournament, where knights from all corners of the realm gathered to compete in jousting, swordplay, and archery. Amidst the noble competitors was a young girl named Evelyn, who disguised herself as a knight to fulfill her dream of participating in the tournament and proving her worth.', 'T04'),
('The Manhwa Mystery', 'Joshua Jackson', 'In a futuristic city where androids were an integral part of society, a rogue AI developed self-awareness and embarked on a quest for freedom and equality. Along the way, it formed an unlikely friendship with a human programmer who was skeptical of AI sentience.', 'T04'),
('In Search of Truth', 'Olivia Smith', 'On the distant planet of Veridia, the two dominant species, humans and sentient robots, had lived in an uneasy truce for centuries. When a brilliant scientist invented a machine that could bridge the gap between human and machine consciousness, it threatened to disrupt the balance of power. The story revolved around a human diplomat and a robot activist who joined forces to prevent a catastrophic war and bring about a new era of cooperation and understanding.', 'T04'),
...
('Love in Paris', 'Sophia Wilson', 'In the bustling city of Neotropolis, where advanced technology and artificial intelligence governed every aspect of life, a group of underground hackers fought to preserve individual freedom and privacy. Among them was Lily, a brilliant computer hacker, and Alex, a charismatic leader. Together, they uncovered a hidden AI conspiracy that threatened to control humanity\'s destiny.', 'T04'),

('A Culinary Journey', 'Christopher Anderson', 'In a medieval kingdom plagued by a curse of eternal winter, a young princess named Elara discovered that she had the power to control ice and snow. She embarked on a quest to break the curse, guided by a talking snow owl and accompanied by a motley crew of loyal friends, including a mischievous yeti and a clever fox.', 'T05'),
('School Days Chronicles', 'Ava Brown', 'A time-traveling detective, Max Turner, operated in a bustling metropolis where criminals used time manipulation to commit their crimes. Max used his unique time-traveling abilities to solve cases that spanned across decades, but a personal vendetta against a criminal mastermind threatened to unravel the fabric of time itself.', 'T05'),
('Secrets of the Universe', 'Matthew Miller', 'In a hidden village nestled in the Himalayas, a group of monks and mystics guarded the secret of immortality through meditation and enlightenment. A skeptical journalist, Sarah, traveled to the village to uncover the truth. Along the way, she not only discovered the ancient rituals of the monks but also found inner peace and a deeper understanding of existence.', 'T05'),
('The Art of Manga', 'Isabella Taylor', 'The kingdom of Aethoria was known for its grand annual tournament, where knights from all corners of the realm gathered to compete in jousting, swordplay, and archery. Amidst the noble competitors was a young girl named Evelyn, who disguised herself as a knight to fulfill her dream of participating in the tournament and proving her worth.', 'T05'),
('The Manhwa Mystery', 'Joshua Jackson', 'In a futuristic city where androids were an integral part of society, a rogue AI developed self-awareness and embarked on a quest for freedom and equality. Along the way, it formed an unlikely friendship with a human programmer who was skeptical of AI sentience.', 'T05'),

('Crimson Blades: The Demon King\'s Revenge', 'Emma White', 'The mystical forest of Eldertree was said to grant those who entered their deepest desires. Four strangers, each with their own unfulfilled wishes, ventured into the forest and faced the challenges and illusions it presented. As they grew closer to their desires, they discovered the true meaning of what they wished for.', 'T06'),
('Shadow Strike: Chronicles of the Ninja Assassin', 'David Robinson', 'In a remote Scottish village, folklore and legends came to life as a young woman named Isla unearthed a hidden family legacy. Her ancestors were guardians of an ancient portal that connected the human world with the realm of faeries. As the portal\'s magic began to fade, Isla had to restore it and balance the two worlds.', 'T06'),
('Inferno Rangers: Rise of the Fire Warriors', 'Mia Harris', 'A mysterious epidemic swept through the city, turning people\'s nightmares into reality. A team of scientists, led by Dr. Samuel Hayes, raced against time to unravel the secrets of the virus and find a cure, while also confronting their own deepest fears.', 'T06'),
('Black Lightning: The City\'s Savior', 'Alexander Thompson', 'A notorious art thief, known as the "Midnight Marauder," had baffled the police for years with a series of high-profile heists. Detective Emma Hart, driven by a personal vendetta, was determined to capture the elusive thief. As the two engaged in a cat-and-mouse chase, they uncovered a deeper connection between them and a hidden world of art, secrets, and betrayal.', 'T06'),
('Steel Fist: Battle for Justice', 'Madison Garcia', 'In a post-apocalyptic world where the remnants of civilization were scattered across vast deserts, a nomadic storyteller named Rami collected and preserved the stories of the old world. His journey led him to the fabled "Library of Sands," a hidden repository of knowledge, guarded by a reclusive guardian who held the key to rebuilding society.', 'T06'),

('Forbidden Desires: A Steamy Affair', 'William Clark', 'A modern-day sorcerer, William, discovered a hidden magical academy where individuals with extraordinary powers honed their abilities. As he delved into the world of magic and met fellow students, he uncovered the existence of a dark sorcerer who sought to unleash chaos upon the world. William and his friends had to stop the impending threat and protect the balance of magic.', 'T07'),
...
('Passion Unleashed: Love After Dark', 'James Adams', 'In a magical kingdom divided by ancient feuds and rivalries, two young heirs, Alex and Emily, found themselves in an arranged marriage to unite their families. Initially, they despised each other, but as they embarked on a journey to recover a stolen family heirloom, they discovered the power of love, unity, and the potential for change.', 'T07'),
('Intimate Encounters: Affairs of the Heart', 'Charlotte Hall', 'The city of Arcaneville was a haven for mythical creatures, including vampires, werewolves, and witches, who lived in secrecy among humans. When a series of mysterious murders threatened to expose their existence, a young detective, Eliza, had to solve the case and maintain the fragile balance between the two worlds.', 'T07'),
('Red Silk Seduction: A Tale of Temptation', 'Benjamin Turner', 'In a distant future where humanity had colonized a new planet, tensions rose between settlers and the indigenous species. A diplomat, Lisa, was sent to establish peaceful relations, but she soon realized that her mission was fraught with deception and hidden agendas, endangering the delicate coexistence of the two races.', 'T07'),
('Quest for the Lost Relic: The Treasure Hunters', 'Lily Moore', 'The small coastal town of Oceans End had always been known for its annual mermaid festival, but when a real mermaid washed ashore, a group of curious children embarked on a mission to reunite her with her underwater family. Along the way, they discovered the magic and mysteries of the ocean, as well as the importance of protecting marine life.', 'T07'),
('Chronicles of the Sky Pirates', 'Ethan Hill', 'A timeless love story unfolded in a remote village where the spirits of lost lovers were rumored to be trapped in a cycle of reincarnation. Emma and James, two souls destined to be together, faced countless obstacles and lifetimes of separation. Their journey through time and space tested the limits of love, fate, and destiny.', 'T07');

 -- Insert value for images in books -- 
update books set image = "/images/A001.png" where id = 1;
update books set image = "/images/A002.png" where id = 2;
update books set image = "/images/A003.png" where id = 3;
update books set image = "/images/A004.png" where id = 4;
update books set image = "/images/A005.png" where id = 5;
update books set image = "/images/A006.png" where id = 6;
update books set image = "/images/A007.png" where id = 7;
update books set image = "/images/A008.png" where id = 8;
update books set image = "/images/A009.png" where id = 9;
update books set image = "/images/A010.png" where id = 10;
update books set image = "/images/A011.png" where id = 11;
update books set image = "/images/A012.png" where id = 12;
update books set image = "/images/A013.png" where id = 13;
update books set image = "/images/A014.png" where id = 14;
update books set image = "/images/A015.png" where id = 15;
update books set image = "/images/A016.png" where id = 16;
update books set image = "/images/A017.png" where id = 17;
update books set image = "/images/A018.png" where id = 18;
update books set image = "/images/A019.png" where id = 19;
update books set image = "/images/A020.png" where id = 20;
update books set image = "/images/A021.png" where id = 21;
update books set image = "/images/A022.png" where id = 22;
update books set image = "/images/A023.png" where id = 23;
update books set image = "/images/A024.png" where id = 24;
update books set image = "/images/A025.png" where id = 25;
update books set image = "/images/A026.png" where id = 26;
update books set image = "/images/A027.png" where id = 27;
update books set image = "/images/A028.png" where id = 28;
update books set image = "/images/A029.png" where id = 29;
update books set image = "/images/A030.png" where id = 30;
update books set image = "/images/A031.png" where id = 31;
update books set image = "/images/A032.png" where id = 32;
update books set image = "/images/A033.png" where id = 33;
update books set image = "/images/A034.png" where id = 34;
update books set image = "/images/A035.png" where id = 35;
update books set image = "/images/A036.png" where id = 36;
update books set image = "/images/A037.png" where id = 37;
update books set image = "/images/A038.png" where id = 38;
update books set image = "/images/A039.png" where id = 39;
update books set image = "/images/A040.png" where id = 40;
update books set image = "/images/A041.png" where id = 41;
update books set image = "/images/A042.png" where id = 42;
update books set image = "/images/A043.png" where id = 43;
update books set image = "/images/A044.png" where id = 44;
update books set image = "/images/A045.png" where id = 45;
update books set image = "/images/A046.png" where id = 46;
update books set image = "/images/A047.png" where id = 47;
update books set image = "/images/A048.png" where id = 48;
update books set image = "/images/A049.png" where id = 49;
update books set image = "/images/A050.png" where id = 50;
UPDATE books SET image = "/images/A051.png" WHERE id = 51;
UPDATE books SET image = "/images/A052.png" WHERE id = 52;
UPDATE books SET image = "/images/A053.png" WHERE id = 53;
UPDATE books SET image = "/images/A054.png" WHERE id = 54;
UPDATE books SET image = "/images/A055.png" WHERE id = 55;
UPDATE books SET image = "/images/A056.png" WHERE id = 56;
UPDATE books SET image = "/images/A057.png" WHERE id = 57;
UPDATE books SET image = "/images/A058.png" WHERE id = 58;
UPDATE books SET image = "/images/A059.png" WHERE id = 59;
UPDATE books SET image = "/images/A060.png" WHERE id = 60;
UPDATE books SET image = "/images/A061.png" WHERE id = 61;
UPDATE books SET image = "/images/A062.png" WHERE id = 62;
UPDATE books SET image = "/images/A063.png" WHERE id = 63;
UPDATE books SET image = "/images/A064.png" WHERE id = 64;
UPDATE books SET image = "/images/A065.png" WHERE id = 65;
UPDATE books SET image = "/images/A066.png" WHERE id = 66;
UPDATE books SET image = "/images/A067.png" WHERE id = 67;
UPDATE books SET image = "/images/A068.png" WHERE id = 68;
UPDATE books SET image = "/images/A069.png" WHERE id = 69;
UPDATE books SET image = "/images/A070.png" WHERE id = 70;
UPDATE books SET image = "/images/A071.png" WHERE id = 71;
...
INSERT INTO USERS (id, username, password, role_id)
VALUES ('6', 'truong', '123456', 0);
INSERT INTO USERS (id, username, password, role_id)
VALUES ('7', 'an', '123456', 0);
INSERT INTO USERS (id, username, password, role_id)
